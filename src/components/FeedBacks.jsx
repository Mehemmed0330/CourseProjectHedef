            ...
            >
                <div className=''>
                    <SwiperSlide className='!h-[30vh]'>
                        <div className="w-full h-full mx-auto rounded-lg bg-[rgb(62,69,149)] border border-gray-200 p-5 text-gray-800 font-light mb-6">
                            <div className="w-full flex mb-4 items-center">
                                <div className="overflow-hidden rounded-full w-[4.375rem] h-[4.375rem] bg-gray-50 border border-gray-200">
                                    <img src={require("../assets/309696525_686406649483698_1989807744559745647_n.jpg")} alt="" />
                                </div>
                                <div className="flex-grow pl-3">
                                    <h6 className="font-bold text-[20px] uppercase text-white ">Kenzie Edgar.</h6>
                                </div>
                            </div>
                            <div className="w-full">
                                <p className="overflow-y-auto h-24 text-white text-sm leading-tight"><span className="text-lg leading-none italic font-bold text-gray-400 mr-1">"</span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos sunt ratione dolor exercitationem minima quas itaque saepe quasi architecto vel! Accusantium, vero sint recusandae cum tempora nemo commodi soluta deleniti.<span className="text-lg leading-none italic font-bold text-gray-400 ml-1">"</span></p>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className='!h-[30vh]'>
